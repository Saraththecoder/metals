  ...
  if (!product) {
    return (
      <div style={{ minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '1rem', padding: '4rem 1.5rem', textAlign: 'center' }}>
        ...
        <h2 style={{ fontFamily: "'Outfit'", fontWeight: 700, fontSize: '2rem', color: 'var(--c-text-primary)', textTransform: 'uppercase' }}>Product Not Found</h2>
        <p style={{ fontFamily: "'Inter'", color: 'var(--c-text-muted)' }}>The requested product doesn't exist in our catalogue.</p>
  ...
  return (
    <div style={{ background: 'var(--c-base)', padding: '2rem 1.5rem 6rem' }}>
      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
        ...
        {/* Breadcrumb */}
        <nav style={{ display: 'flex', alignItems: 'center', gap: '0.375rem', fontFamily: "'Inter'", fontSize: '0.75rem', color: 'var(--c-text-muted)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '2.5rem', flexWrap: 'wrap' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '2.5rem' }} className="detail-grid">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            ...
            <div>
              <span style={{ display: 'inline-block', fontFamily: "'Inter'", fontWeight: 700, fontSize: '0.65rem', textTransform: 'uppercase', letterSpacing: '0.18em', color: 'var(--c-blue-lt)', background: 'rgba(0,80,240,0.1)', border: '1px solid rgba(0,80,240,0.25)', padding: '0.25rem 0.75rem', marginBottom: '1rem' }}>
                {product.category}
              </span>
              <h1 style={{ fontFamily: "'Outfit'", fontWeight: 800, fontSize: 'clamp(1.8rem, 4vw, 3rem)', textTransform: 'uppercase', letterSpacing: '-0.01em', color: 'var(--c-text-primary)', marginBottom: '0.625rem' }}>
                {product.name}
              </h1>
              <p style={{ fontFamily: "'Inter'", fontSize: '1rem', color: 'var(--c-blue-lt)', fontStyle: 'italic', fontWeight: 500 }}>
                {product.tagline}
              </p>
            </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }} className="detail-sidebar">
            <div className="detail-sticky">
              ...
              <div style={{
                ...
                <div style={{ flex: 1 }}>
                  <p style={{ fontFamily: "'Outfit'", fontWeight: 700, fontSize: '0.8rem', textTransform: 'uppercase', color: 'var(--c-text-primary)', marginBottom: '0.2rem' }}>Chat on WhatsApp</p>
                  <p style={{ fontFamily: "'Inter'", fontSize: '0.75rem', color: 'var(--c-text-muted)', lineHeight: 1.5 }}>Instant price negotiation</p>
                </div>
        ...
        {related.length > 0 && (
          <>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
              <h3 style={{ fontFamily: "'Outfit'", fontWeight: 700, fontSize: '1.25rem', textTransform: 'uppercase', color: 'var(--c-text-primary)' }}>
                Related Products
              </h3>
              <Link to="/products" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.375rem', fontFamily: "'Inter'", fontWeight: 600, fontSize: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.1em', color: 'var(--c-blue-lt)', textDecoration: 'none' }}>
